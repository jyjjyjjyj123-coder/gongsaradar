...
<h1>개인정보처리방침</h1>
<p>이브이네트웍스(주) (이하 "회사")는 「개인정보 보호법」에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하게 처리하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.</p>
...
<h2>6. 개인정보보호 책임자</h2>
<ul><li>회사명: 이브이네트웍스(주)</li><li>대표자: 장용준</li><li>서비스명: 공사인프라</li></ul>
