...
async function collectAll() {
  ...
  if (allItems.length>0) { fs.writeFileSync(CACHE_FILE,JSON.stringify({updatedAt:new Date().toISOString(),totalCount:allItems.length,items:allItems})); console.log(`✅ ${allItems.length}건 저장\n`); }
